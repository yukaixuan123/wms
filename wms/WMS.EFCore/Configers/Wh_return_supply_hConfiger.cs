...
namespace WMS.EFCore.Configers
{
    ...
    /// 进货退货表
    /// </summary>
    internal class Wh_return_supply_hConfiger : IEntityTypeConfiguration<Wh_return_supply_h>
    {
        public void Configure(EntityTypeBuilder<Wh_return_supply_h> builder)
        {
            builder.ToTable(nameof(Wh_return_supply_h));
            ...
            builder.Property(e => e.returns_num).HasColumnType("decimal(18,2)").IsRequired();
            builder.Property(e => e.returns_money).HasColumnType("decimal(18,2)").IsRequired();
            ...
            builder.Property(e => e.create_by).HasMaxLength(500).IsUnicode(false).IsRequired(false);
