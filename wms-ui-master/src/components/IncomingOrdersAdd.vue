    ...
    <div id="addx">
      ...
      <div style="margin-top: 50px; margin-left: 30px">
        ...
        >
          ...
          <el-table-column prop="unit" label="单位" width="114px">
...
export default {
  ...
  methods: {
    ...
    bc(formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          $http
            .get(
              "http://localhost:5149/api/Wh_buy_order_h/Wh_buy_order_h_Insertt",
              {
                params: {
                  json: jsonString,
                  xx: jsonString1,
    ...
    qd() {
      ...
      // this.tableData = [...this.tableData, ...this.multipleSelection1];
    ...
    Dang() {
      $http
        .get("http://localhost:5149/api/Sys_encode/FindSys_encodeById?id=" + 3)
        .then((res) => {
          this.formInline.buy_code = res;
        })
        .catch((err) => {
          alert(err);
        });
