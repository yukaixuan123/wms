    ...
    <div id="addx">
      ...
      <div style="margin-top: 50px; margin-left: 30px">
        ...
        >
          ...
          <el-table-column prop="kc" label="当前库存" width="90">
          </el-table-column>
          <el-table-column label="货品数量" width="115px">
            <template slot-scope="scope">
              <input
                ...
                value="0"
                v-model="tableData[scope.$index].inbill3_num"
              />
            </template>
          </el-table-column>
          <el-table-column label="销售单价" width="115px">
            <template slot-scope="scope">
              <input
                ...
                v-on:keyup="onKeyPress(scope.$index + 1)"
                v-model="tableData[scope.$index].sale_price"
              />
            </template>
          </el-table-column>
          <el-table-column label="销售金额" width="85">
            <template slot-scope="scope">
              <input
                ...
                :value="scope.row.inbill3_num * scope.row.sale_price"
              />
            </template>
          </el-table-column>
    ...
    bc(formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          $http
            .get("http://localhost:5149/api/Wh_sale_h/Wh_sale_h_Update", {
              params: {
                json: jsonString,
                xx: jsonString1,
              },
    ...
    findId() {
      $http
        ...
        .then((res) => {
          ...
          this.formInline.sale_date = res.sale_date;
      ...
      $http
        ...
        .then((res) => {
          ...
          for (let i = 0; i < this.tableData.length; i++) {
            this.hpsl += this.tableData[i].inbill3_num;
            this.zje +=
