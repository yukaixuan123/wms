  ...
  <div>
    <div id="addsss">
      <h3 style="margin-left: 35px; padding-top: 30px; display: inline-block">
        销售退货单号：{{ this.$route.query.sr_code }}
        <img
          src="../Images/fz.png"
          width="20px"
          height="20px"
      ...
      <el-tabs id="menu" v-model="activeName" @tab-click="handleClick">
        <el-tab-pane label="退货明细" style="margin-top: -10px" name="first">
          ...
          >
            ...
            <el-table-column prop="item_name" label="货品名称" width="110">
            </el-table-column>
            <el-table-column prop="item_code" label="货品编号" width="110">
            </el-table-column>
            <el-table-column prop="item_type_name" label="货品类型" width="110">
            </el-table-column>
            <el-table-column prop="model_code" label="规格型号" width="110">
            </el-table-column>
            <el-table-column prop="unit" label="单位" width="110">
            </el-table-column>

            <el-table-column prop="inbill3_num" label="销售数量" width="110">
            </el-table-column>
            <el-table-column prop="treat_num" label="退货数量" width="114">
  ...
  methods: {
    delAll() {
      this.$router.push({
        path: "/SalesReturnsTH",
        query: {
          sr_code: this.$route.query.sr_code,
        },
      });
    },
    sgb() {
    ...
    findrrk() {
      $http
        .get(
          "http://localhost:5149/api/Wh_sale_return_h/Wh_sale_return_h__sr213lAsyunc?inbill_bh=" +
            this.$route.query.sr_code +
            ""
        )
        .then((res) => {
