  ...
  <div>
    <div id="adds">
      ...
      <div style="margin-top: 30px">
        ...
        >
          ...
          <el-form-item label="出库日期" prop="date" id="ru">
            <el-date-picker
    ...
    <div id="addx">
      ...
      <div style="margin-top: 50px; margin-left: 30px">
        ...
        >
          ...
          <el-table-column prop="cw" label="出库仓位" width="140px">
            <template slot-scope="scope">
              <select
          ...
          <el-table-column prop="change" label="本次出库数量" width="140">
            <template slot-scope="scope">
              <input
                type="text"
    ...
    >
      ...
      >
        ...
        <el-table-column label="销售日期" width="140">
          <template slot-scope="scope">
...
export default {
  ...
  methods: {
    ...
    Dang() {
      $http
        .get("http://localhost:5149/api/Sys_encode/FindSys_encodeById?id=" + 4)
        .then((res) => {
    ...
    find() {
      $http
        .post(
          "http://localhost:5149/api/Wh_outbill_h/FenOrder?page=" +
            this.pagesize +
            "&pageSize=" +
            this.currentPage +
            "&str=" +
    ...
    onSubmit() {
      ...
      if (this.formtable.jhr != "") {
        this.str += "and sale_duty_man = '" + this.formtable.jhr + "'";
      }
    ...
    CK() {
      ...
      //客户
      $http
        .get("http://localhost:5149/api/Wh_outbill_h/Bs_customerFind")
        .then((res) => {
          t.countryList3 = res;
        })
        .catch((err) => {
    ...
    bc() {
      ...
      this.$refs["formInline1"].validate((valid) => {
        ...
        if (this.formInline.gldh.trim() == "") {
          ...
          $http
            .get("http://localhost:5149/api/Wh_outbill_h/KK1", {
              params: {
        ...
        if (this.formInline.gldh.trim() != "") {
          ...
          $http
            .get("http://localhost:5149/api/Wh_outbill_h/KK", {
              params: {
                arrayList: serializedData,
                xx: serializedData1,
              },
    ...
    handleRowClick(i) {
      this.formInline.gldh = i.sale_code;
      this.formInline.gys = i.cust_code;
      ...
      $http
        .post(
          "http://localhost:5149/api/Wh_outbill_h/Wh_sale_BH?str=" + i.sale_code
        )
        .then((res) => {
          t.tableData = res;
        })
