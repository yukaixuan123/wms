      ...
      <div style="margin-top: 50px; margin-left: 30px">
        ...
        >
          ...
          <el-table-column label="账面金额" width="140">
            <template slot-scope="scope">
              <span :id="'jin' + (scope.$index + 1)"></span>
            </template>
          </el-table-column>
          <el-table-column prop="cw" label="盘点仓位" width="140px">
            <template slot-scope="scope">
              <select
          ...
          <el-table-column prop="change" label="盘点数量" width="140">
            <template slot-scope="scope">
              <input
                type="text"
          ...
          <el-table-column label="盈亏数量" width="140">
            <template slot-scope="scope">
              <span :id="'weiSum' + (scope.$index + 1)"></span>
            </template>
          </el-table-column>
          <el-table-column label="盘点状态" width="140">
            <template slot-scope="scope">
              <el-tag :id="'elTag' + (scope.$index + 1)" disable-transitions>
              </el-tag>
            </template>
          </el-table-column>
...
export default {
  ...
  methods: {
    ...
    Dang() {
      $http
        .get("http://localhost:5149/api/Sys_encode/FindSys_encodeById?id=" + 8)
        .then((res) => {
    ...
    bc() {
      ...
      this.$refs["formInline1"].validate((valid) => {
        ...
        $http
          .get("http://localhost:5149/api/Wh_inventory_h/Insert", {
            params: {
