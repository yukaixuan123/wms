...
export default {
  ...
  methods: {
      ...
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          const s = {
            ...
            supply_code: this.formInline.supply_code,
            buy_code: this.formInline.buy_code,
            link_man: this.formInline.link_man,
            link_way: this.formInline.link_way,
            remark: this.formInline.remark,
            buy_man: this.formInline.buy_man,
          ...
          $http
            .get(
              "http://localhost:5149/api/Wh_return_supply_h/Wh_return_supply_h_Insert",
              {
                params: {
                  json: jsonString,
                  xx: jsonString1,
    ...
    Dang() {
      $http
        .get("http://localhost:5149/api/Sys_encode/FindSys_encodeById?id=" + 11)
        .then((res) => {
          this.formInline.returns_code = res;
        })
        .catch((err) => {
          alert(err);
        });
