  ...
  <div>
    <div id="addss">
      ...
      >
        <tr>
          <td>
            出库类型<i style="margin-left: 50px; color: #999999">{{
              formInline.lx
            }}</i>
          </td>
          ...
          <td>
            客户<i style="margin-left: 50px; color: #999999">{{
              formInline.gys
            }}</i>
          </td>
        ...
        <tr>
          ...
          <td>
            出货日期<i style="margin-left: 50px; color: #999999">{{
              filterTime(formInline.date)
            }}</i>
          </td>
          <td>
            收货人<i style="margin-left: 50px; color: #999999">{{
              formInline.lxr
            }}</i>
          </td>
        </tr>
      ...
      <el-tabs id="menu" v-model="activeName" @tab-click="handleClick">
        <el-tab-pane label="入库明细" style="margin-top: -10px" name="first">
          ...
          >
            ...
            <el-table-column prop="area_code" label="出库仓位" width="100">
            </el-table-column>
            <el-table-column prop="sale_price" label="出库单价" width="100">
            </el-table-column>
      ...
      $http
        ...
        .then((res) => {
          ...
          for (let i = 0; i < this.tableData.length; i++) {
            this.yrksl += this.tableData[i].outbill_num;
